...
class TSNE(BaseEstimator):
    ...
    def __init__(self, n_components=2, *, perplexity=30.0,
                 ...
                 n_jobs=None, cluster_ids=[], shrinkage=0.4, cluster_supervise=False):
        ...
        self.cluster_supervise = cluster_supervise
    ...
    def _fit(self, X, skip_num_points=0):
        ...
        if self.method == "exact":
            ...
            if self.cluster_supervise:
                for i in range(distances_nn.shape[0]):
                    distances_nn[i,self.cluster_ids[self.cluster_ids['cids'][i]]] =  \
                        distances_nn[i,self.cluster_ids[self.cluster_ids['cids'][i]]] * self.shrinkage
            duration = time() - t0
            if self.verbose:
